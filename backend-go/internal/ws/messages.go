...
const (
	...
	MsgSetStakes      MessageType = "set_stakes"
	MsgRequestRedeal  MessageType = "request_redeal"
	MsgRedealResponse MessageType = "redeal_response"
)
...
const (
	...
	MsgRedealRequested      MessageType = "redeal_requested"
	MsgRedealResponseNeeded MessageType = "redeal_response_needed"
	MsgRedealPerformed      MessageType = "redeal_performed"
	MsgRedealDeclined       MessageType = "redeal_declined"
)
...
type ClientMessage struct {
	...
	Stakes     int         `json:"stakes,omitempty"`
...
type ServerMessage struct {
	...
	PerfectWin  bool           `json:"perfectWin,omitempty"`
	Stakes      int            `json:"stakes,omitempty"`
	Winnings    int            `json:"winnings,omitempty"`
	RedealCount int            `json:"redealCount,omitempty"`
	MaxRedeals  int            `json:"maxRedeals,omitempty"`
...
func NewGameStateInfo(g *game.Game) *GameStateInfo {
	...
	_, redealCount, maxRedeals := g.GetRedealInfo()
